...
<p align="justify"> We follow definitions for the normative approach of skills mismatch established by ILO and ONS to calculate:
■ people who are overeducated for their occupation. This, by matching an individual's higher qualification (ISCDE) and occupation (ISCO) first-digit indicator.
</p>
...
p_nskills <- n_skills %>% 
  ...
  labs(x = "Year", 
       y = "Percentage", 
       title ="Figure 1: Overeducated workers (percentage)",
       subtitle  = "By gender",
       caption = ""
       ) +
...
pskills_total <- n_skills %>% 
  ...
  theme_economist_white(gray_bg = FALSE, base_family = "Lato") +
  theme(plot.margin = unit(c(0, 0, 0, 0), "lines"),
        plot.title = element_text(size = 14, margin = ggplot2::margin(5, 5, 0, 0)),
...
p_nskills_age <- n_skills_age %>% 
  ...
  # scale and colour
  scale_color_discrete_qualitative(palette = "Dark 3") +
  scale_y_continuous(breaks = seq(0,0.25, 0.05), limits = c(0, 0.25), labels =
                       scales::percent_format(accuracy = 1L), expand = c(0,0), sec.axis = dup_axis()) +
  scale_x_continuous(breaks=c(1:68), position = "top",
                     labels=c("","2006","", "", "", "2007", "", "", "", "2008", "", "", "", "2009", "", 
                            "", "", "2010", "", "", "", "2011", "", "", "", "2012", "", "", 
...
```{r overeducation by nation table by REGWKR, echo=FALSE}
...
p_nskills_reg <- n_skills_reg %>% 
  ...
  # scale and colour
  scale_color_discrete_qualitative(palette = "Dark 3") +
  scale_y_continuous(breaks = seq(0,0.18,0.03), limits = c(0, 0.18), labels =
                       scales::percent_format(accuracy = 1L), expand = c(0,0), sec.axis = dup_axis()) +
  scale_x_continuous(breaks=c(1:68), position = "bottom",
                     labels=c("","2006","", "", "", "2007", "", "", "", "2008", "", "", "", "2009", "", 
                            "", "", "2010", "", "", "", "2011", "", "", "", "2012", "", "", 
...
p_nskills_con <- n_skills_con %>% 
  ...
  # scale and colour
  scale_color_discrete_qualitative(palette = "Dark 3") +
  scale_y_continuous(breaks = seq(0,0.15,0.03), limits = c(0, 0.15), labels =
                       scales::percent_format(accuracy = 1L), expand = c(0,0), sec.axis = dup_axis()) +
  scale_x_continuous(breaks=c(1:68), position = "bottom",
                     labels=c("","2006","", "", "", "2007", "", "", "", "2008", "", "", "", "2009", "", 
                            "", "", "2010", "", "", "", "2011", "", "", "", "2012", "", "", 
