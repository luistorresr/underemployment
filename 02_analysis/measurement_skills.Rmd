...
<p align="justify">Skills-related underemployment, skills underutilisation or overqualification is defined as a situation of mismatch between the skills needed and the skills offered in the labour market, in which the skills from individuals surpasses the requirements of a job (Rafferty, 2020). Furthemore, skills-related underemployment is a relevant issue for nations and companies alike, in which the full potential and productive capability of employees is not being used (ILO, 2014).
According to ILO (2008), skills-related underemployment is measured through a proxy that compares the relation between the highest qualification held by an employee and their current occupation. In national surveys such as the LFS, this can be measured through a normative approach or a statistical approach. For this report it is used a normative approach because according to the literature (Sutherland, 2012; Tarvid, 2012), it allows to standardized the categories of "Overqualified", "Matched" and "Underqualified" through time.
...
For this report, skills-related underemployment is depicted by personal characteristics, job arrangements, and sectoral division (geographic and industrial).</p> 

## Trends by personal characteristics 

<p align="justify">This section indicates the development of skill-related underemployment between 2006 and 2022 in the UK in terms of gender (men and women), age segments, ethnicity and educational level.</p>

### Men and women

<p align="justify"> Figure 1 illustrates that the proportion of individuals categorised as skills-related underemployed has steadily increased between 2006 to 2022. Nonetheless, although between 2006 and 2008 the percentage of overqualified male and female workers was similar, since 2009 to 2022 the gap between women and men has widened, in which by 2022 the percentage of female workers under this condition was 2,89% higher than male workers.</p>   

```{r overqualification by men and women table by SEX, echo=FALSE}
...
```{r plot overqualified employees, fig.width=9, fig.height=6, fig.fullwidth=TRUE, fig.cap= "workers who have a qualification above the required for their occupation"}
...
<p align="justify"> Figure 2 shows that although it is possible to identify the age group of "Between 18 and 24 years old" as the one with the largest percentage of its members are skills-related underemployment, the majority of individuals under this conditions are part of the "Between 25 and 34 years old" group.</p>  


```{r overqualification by age table by AGE, echo=FALSE}
...
```{r overqualification by ethnicity table by ETH, echo=FALSE}
...
<p align="justify">Figure 4 highlights the educational level of "Degree or above" as the group with the highest number of individuals categorised as skills-related underemployed throughout 2006 to 2022. Furthermore, although the number of overqualified workers that hold a "Higher education" and "GCE, A-level or equivalent" has not experienced relevant changes in this period, the percentage of overqualified employees with a "Degree or above" has increased by 5,99%.</p>

```{r overqualification by educational level table by quali, echo=FALSE}
...
<p align="justify">Meanwhile, this section depicts the distribution of skill-related underemployed individuals in terms of occupational category, work arrangement and flexible employment.</p>

### Occupational category

<p align="justify">Figure 5 shows the "Intermediate" occupational category as the group with the largest proportion of overqualified employees. Nonetheless, the majority of skill-related underemployed are related to "routine and semi-routine" occupations. In addition, figure 5 indicates that between 2006 and 2022 only managerial positions have not experienced a relevant increase of employees that have higher qualifications than those required for their roles.</p>


```{r overqualification by occupational category table by nsec2, echo=FALSE}
...
<p align="justify">Figure 6 shows that the proportion of overqualified employees is larger among those in a "non-permanent" work arrangement than those with a "permanent" contract. In addition, this figure illustrates that the number of employees in a non-permanent work arrangement has relevant variations throughout each year.</p>   

```{r overqualification by work arrangement table by JOBTYP, echo=FALSE}
...
```{r overqualification by flexible employment type table by FLED, echo=FALSE}
...
```{r plot skills overqualified employees, fig.width=9, fig.height=6, fig.fullwidth=TRUE, fig.cap= "workers who have a qualification above the required for their occupation"}
...
p_nskills_fled <- n_skills_fled %>% 
  ...
  labs(x = "Year", 
       y = "Percentage", 
       title ="Figure 7. Overqualified workers in flexible employment (percentages and totals)",
       subtitle  = "",
       caption = ""
       ) +
...
<p align="justify">Lastly, this section illustrates the distribution of skills-related underemployment by UK's nations and regions as well as its industry sectors. It is important to note that this report focuses on the industry sectors and regions that contain the cities related to the current research project.</p> 

### Region

<p align="justify">Figure 7 shows that the four regions in which the cities involved in the current research are located have experienced between 2006 and 2022 a steady increase of overqualified workers. Furthermore, currently 13% of the population of the "Greater Manchester" and "Strathclyde" and "South West" is categorised as skills-related underemployed while 11% of the population from the "East Midlands" region is in this condition.</p>   

```{r overqualification by region table by REGWKR, echo=FALSE}
...
<p align="justify">Likewise, between 2006 and 2022 the four nations from the UK have experienced a steady increase of employees that have higher qualifications than the one required in their jobs. In this regard, Scotland is currently the country with largest percentage of overqualified employees, with a 2% above the other three nations.</p>

```{r overqualification by nation table by country2, echo=FALSE}
...
p_nskills_con <- n_skills_con %>% 
  ...
  labs(x = "Year", 
       y = "Percentage", 
       title ="Figure 9. Overqualified workers by nation",
       subtitle  = "",
       caption = ""
       ) +
...
<p align="justify">Finally, figure 10 shows that between 2006 and 2022 the percentage of overqualified employees has been higher in the retail industry than the human health. In addition, although it is also possible to observe that both activities have experienced a similar development until 2021, in 2022 only in the human health sector the number of overqualified employees has decreased in comparison to the previous year.</p> 


```{r overqualification by industry sector table by ind1, echo=FALSE}
...
p_nskills_ind <- n_skills_ind %>% 
  ...
  labs(x = "Year", 
       y = "Percentage", 
       title ="Figure 10. Overqualified workers by industry (percentages and totals)",
       subtitle  = "",
