...
p_ptime_total <- t_ptime %>% 
  ...
  scale_y_continuous(breaks = seq(0,1000000, 100000), limits = c(0, 1000000), labels = comma, expand = c(0,0), sec.axis = dup_axis()) +
...
```{r plot involuntary part time nsec, fig.width=8, fig.height=4, fig.fullwidth=TRUE, fig.cap= ""}
...
p_ptime_nsec <- t_ptime_nsec %>% 
  ...
  labs(x = "", 
       y = "Percentage", 
       title ="Figure 2: Part-time workers who could not find a full-time job by occupational category",
       subtitle  = "",
...
p_undemp_total <- t_undemp %>% 
  ...
  # scale and colour
  scale_fill_discrete_qualitative(palette = "Dark 3") +
  scale_y_continuous(breaks = seq(0,2000000, 250000), limits = c(0, 2000000), labels = comma, expand = c(0,0), sec.axis = dup_axis()) +
  scale_x_continuous(breaks=c(1:68),
                     labels=c("","2006","", "", "", "2007", "", "", "", "2008", "", "", "", "2009", "", 
                            "", "", "2010", "", "", "", "2011", "", "", "", "2012", "", "", 
                            "", "2013", "", "", "", "2014", "", "", "", "2015", "", "", "", 
...
p_undemp_nsec <- t_undemp_nsec %>% 
  ...
  labs(x = "", 
       y = "Percentage", 
       title ="Figure 4: Wants to work more hours in current job by occupational category",
       subtitle  = "",
       caption = c("")
       ) +
...
p_undemp_rate_ptime <- t_undemp_ptime %>% 
  ...
  labs(x = "", 
       y = "Percentage", 
       title ="Figure 5: Wants to work more hours in current job",
...
p_more_hours2 <- t_extra_hours2 %>% 
  ...
  labs(x = "", 
       y = "Hours", 
       title ="Figure 6: Median extra hours wished to work",
...
p_seeking <- t_seeking %>% 
  ...
  # scale and colour
  scale_fill_discrete_qualitative(palette = "Dark 3") +
  scale_y_continuous(breaks = seq(0,1200000, 100000), limits = c(0, 1200000), labels = comma, expand = c(0,0), sec.axis = dup_axis()) +
  scale_x_continuous(breaks=c(1:68), position = "bottom", 
                     labels=c("","2006","", "", "", "2007", "", "", "", "2008", "", "", "", "2009", "", 
                            "", "", "2010", "", "", "", "2011", "", "", "", "2012", "", "", 
                            "", "2013", "", "", "", "2014", "", "", "", "2015", "", "", "", 
  ...
  labs(x = "Year", 
       y = "Total", 
       title ="Figure 7: Seeking replacement job",
       #subtitle  = "Totals based on people in employment between 2006 and 2022",
       caption = c("")
       ) +
...
p_seeking_hours <- t_seeking_hours %>% 
  ...
  labs(x = "", 
       y = "Percentage", 
       title ="Figure 8: Preferred working hours in new job being looked for",
       #subtitle  = " ",
       caption = c("")
       ) +
