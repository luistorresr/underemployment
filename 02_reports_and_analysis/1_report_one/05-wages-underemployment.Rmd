...
<p align="justify">Most underemployment indicators are calculated based only on working less than a threshold related to working time (time-related underemployment). Wage-related underemployment is not typically reported in national statistics, and, as such, there is no one standard method for its estimation.</p> 

<p align="justify">@Feldman1996 suggests that wage-related underemployment can me measured by looking at those workers who earn wages 20% or less than in the previous job or, for new graduates, wages 20% or less than average of graduating cohort in same major or occupational track. In @Clogg1986 low-income measures are identified as indicators of wage underemployment. Two measures are here underlined: poverty workers and inequitable pay. The 'poverty workers' measure is calculated based on the previous year earning compared to a normative weekly wage defined as 1.25 times the poverty threshold. The 'inequitable pay' measure is based on a regression equation predicting "fair pay" taking white males earning as the standard. @Frances2011 refer to pay/hierarchical underemployment. This concept represents workers who are underpaid or at a lower hierarchical status compared with their previous job  (for workers made redundant) or than similarly skilled employees.</p> 

<p align="justify"> Based on these definitions, we measure wage-related underemployment based on employees who are underpaid in the same occupational track. An underpaid employee is here considered as anyone receiving wages 20% lower than the median in the occupational category. Our measure is based on:</p>
...
- <p align="justify">the median instead of the average because the average is sensitive to outliers (abnormally low or high values), while the median is much less affected by them.</p>
- <p align="justify">the gross hourly pay.</p>

<p align="justify">The table below summarises the baseline data we use in our analysis. We consider nine main occupational tracks (main jobs only) and calculate an "underpaid median wage" based on the 20% and less of the median wage per hour. Then, we estimate the number of underpaid employees and its proportion considering all employees in the occupational track (underpaid rate). Following this procedure, we are able to estimate the underpaid rate for each period included in this analysis.</p> 
...
t_underpaid_occu %>% gt(groupname_col = NULL) %>%
   ...
   tab_header(
      title = md("**Underpaid employees baseline data**"),
...
<p align="justify"> Figure \@ref(fig:plot-underpaid-sex) shows the underpaid rate and totals for male and female employees. Female employees are the most affected by lower wages. Up to 32% of women were underpaid in April/June 2020, while the highest level for men was reached in April/June 2010 with an all high 24%. This rate represents a difference of up to 960,516 more underpaid female employees compared with male employees. Levels have remained just above 20% for men and just below 30% for women in most periods.</p> 
...
<p align="justify">Figure \@ref(fig:plot-underpaid-age) shows that employees between 18 to 34 years old are the most affected by wage underemployment. This is particularly the case for employees between 18 to 24 with rates above 50% in some periods. Underpaid employees are also high in other age groups where levels have remained around 20% for all periods.</p>
...
```{r plot-underpaid-age, fig.width = 7, fig.asp = 0.5, out.width = '100%', fig.fullwidth = TRUE, out.width = '100%', fig.cap= "Young employees are the most underpaid"}
...
<p align="justify">Figure \@ref(fig:plot-underpaid-ethnicity) shows the rate of underpaid employees according to their ethnicity group. Overall, the proportion of underpaid minority-ethnic employees is higher than the white majority employees for most periods. However, the differences have reduced since the Covid-19 pandemic hit. The third quarter of 2020 saw a reduction in the rate of minority-ethnic employees below white employees. This trend remained for seven quarters until the second quarter of 2022.</p> 
...
```{r plot-underpaid-ethnicity, fig.width = 7, fig.asp = 0.5, out.width = '100%', fig.fullwidth = TRUE, out.width = '100%', fig.cap= "The proportion of underpaid minority-ethnic employees is slightly higher than their white counterparts for most periods"}
...
<p align="justify"> Employees with a degree and higher education qualifications are less affected by wage underemployment than those without a qualification, as Figure \@ref(fig:plot-underpaid-education) show. Levels have dropped for those employees without a qualification during 2022, but show again an increase in its last quarter.</p>
...
<p align="justify"> As Figure \@ref(fig:plot-underpaid-nsec) show, employees in management and professional occupations are more likely to experience wage-related underemployment. Although routine and semi-routine occupations are also affected, this trend is different from time and skills-related underemployment where this occupations group was more impacted.</p>
...
<p align="justify"> As Figure \@ref(fig:plot-underpaid-region) show, wage-related underemployment is present in high levels in all regions included in this analysis. While Scotland shows slightly lower levels than other regions, East Midlands, North West and South West concentrate the highest levels. However, trends are not stable and tend to fluctuate greatly in all periods.</p>
...
<p align="justify"> As Figure \@ref(fig:plot-underpaid-ind) show, wage underemployment is pervasive in the accommodation and food service sector. Employees in education, retail  and human health and social work are also affected.</p>
